<?php
$current_password = $new_password = $retype_new_password = $password= $encrypted_password = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
  ...
  else 
  {
    ...
    else 
    {
      ...
      {
      $current_passwordErr = "Password doesn't match";
      $current_password="";
      }
  ...
  else 
  {
    ...
    {
      $retype_new_passwordErr = "Password doesn't match";
      $retype_new_password="";
    }
    else if(($retype_new_password==$new_password) && ($current_password== $password))
    {
